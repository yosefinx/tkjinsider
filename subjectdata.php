...
$subjectdata = query("SELECT tb_mapel.nama_mapel, tb_gurustaff.nama_gurustaff, tb_gurustaff.gurustaff_id, tb_gurustaff.gender_gurustaff 
FROM tb_mapel 
INNER JOIN tb_gurustaff ON tb_gurustaff.gurustaff_id = tb_mapel.gurustaff_id;")
    ...
    <div class="right">
        <div class="content">
            <div class="content-hello" style="position: absolute;">
                <div>
                    <h2 style="font-weight: 500;">Subject Data</h2>
                </div>
                <div>
                ...
                <div>
                    <table style="width:1000px; margin-top:40px; ">
                        ...
                        <?php foreach ($subjectdata as $key => $row) : ?>
                            <tb>
                                <tr>

                                    <td><?= $row["nama_mapel"] ?></td>
                                    <td><?= $row["gurustaff_id"] ?></td>
                                    <td><?= $row["nama_gurustaff"] ?></td>
                                    <td><?= $row["gender_gurustaff"] ?></td>
                                </tr>
                            </tb>
                        <?php endforeach; ?>
                    </table>
