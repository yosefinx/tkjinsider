            ...
            <div class="content-hello" style="position: absolute; display:flex; flex-direction:column;">
                ...
                <div style="max-width: 600px; margin-top:40px; margin-left:35px;">
                    ...
                    <form action="" method="post" style="border: 1px solid #ccc; padding: 20px; border-radius: 5px; width:900px">
                        ...
                        <input type="hidden" name="mapel_id" class="form-control" value="<?= $mapel_id ?>">
                        <input type="hidden" name="ketkel_id" class="form-control" value="<?= $ketkel_id ?>">
                        ...
                        <div style="margin-bottom: 10px;">
                            ...
                            <input type="text" name="judul" class="form-control" value="" style="width: 880px; padding: 8px; border: 1px solid #ccc; border-radius: 3px;">
                        </div>

                        <div style="margin-bottom: 10px;">
                            <label style="display: block; ">Deadline</label>
                            <input type="text" name="deadline" class="form-control" value="" style=" width: 880px; padding: 8px; border: 1px solid #ccc; border-radius: 3px;">
                        </div>
                        <div style="margin-bottom: 10px;">
                            <label style="display: block; ">Description</label>
                            <input type="text" name="desc_tugas" class="form-control" value="" style="width: 880px; padding: 8px; border: 1px solid #ccc; border-radius: 3px;">
                        </div>
