        ...
        <div class="content">
            <div class="content-hello" style="position: absolute; display:flex; width:1100px;">
                                ...
                                <div style="padding: 20px;">
                                    ...
                                    <div style="margin-top:10px; display:flex;">
                                        <form action="" method="post">
                                            ...
                                            <button style="background-color: <?php if ($row["status"] != "Submitted") {
                                                                                    echo '#04AA6D';
                                                                                } else {
                                                                                    echo '#5c5c55';
                                                                                }; ?>; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; border-radius:30px;" name="status" <?php if ($row["status"] == "Submitted") {
                                                                                                                                                                                                                                                                    echo 'disabled';
                                                                                                                                                                                                                                                                } ?>> <?= $row["status"] ?> <?php if ($row["status"] == "Submitted") {
                                                                                                                                                                                                                                                                                                echo "at " . date('l, d F Y', strtotime($row["submitted_at"]));;
                                                                                                                                                                                                                                                                                            } ?></button>
                                        </form>

                                        <?php if ($row["submitted_at"] > $row["deadline"]) : ?>
                                            <p style="color: #EA4644; font-weight:bold; margin-top:15px; margin-left:10px;">Turn in late</p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                ...
                <?php if ($nama_role == "Ketua Kelas") : ?>
                    <div style="margin-top:12px; padding:10px; background-color:#FEBE00; border-radius:10px; margin-left:410px">
                        <a style="text-decoration:none; color:#ffffff;" href="editaddassignment.php?mapel_id=<?= $mapel_id ?>">Edit/Add Assignment</a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
