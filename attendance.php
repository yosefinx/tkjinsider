        ...
        <div class="content">
            <div class="content-hello" style="position: absolute;">
                <div style="display: flex;">
                    <div>
                        <div>
                            <h2 style="font-weight: 500;">My Attendance</h2>
                        </div>
                        <div>
                    ...
                    <?php if ($nama_role == 'Ketua Kelas') : ?>
                        <div style="margin-top:10px; margin-left:480px;">
                            <a style="color:#ffffff; background-color:#FEBE00; border-radius:20px; text-decoration:none; padding:8px;" href="classattend.php">
                                <span class="title">Class Attend</span>
                            </a>
                        </div>
                    <?php endif; ?>
                </div>
                        ...
                        <?php foreach ($attendance as $key => $row) : ?>
                            <tb>
                                <tr>
                                    ...
                                    <td><?= date('l, d F Y', strtotime($row["tgl_absensi"])); ?></td>
                                    <td><?= $row["jam_absensi"] ?></td>
                                    <td><?= $row["status"] ?></td>
